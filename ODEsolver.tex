...
$$
\left\|{\Phi}(t, \boldsymbol{y} ; h)-\boldsymbol{\Phi}\left(x, \boldsymbol{y}^* ; h\right)\right\| \leq M\left\|\boldsymbol{y}-\boldsymbol{y}^*\right\| \text { on }[a, b] \times \mathbb{R}^d \times\left[0, h_0\right]
$$
